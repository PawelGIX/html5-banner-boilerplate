...
}).prototype = getMCSymbolPrototype(lib.text, new cjs.Rectangle(0,4,728,355.4), null);
...
(lib.subhead = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#32307A").s().p("");
	this.shape.setTransform(-0.3,2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.subhead, new cjs.Rectangle(-219.1,-8.7,437.7,21.4), null);
...
(lib.head = function(mode,startPosition,loop) {
	...
	this.shape_5.setTransform(39.1,-6.1);
	...
	this.shape_6.setTransform(14.8,-3.6);
	...
	this.shape_7.setTransform(-9.1,0.5);
	...
	this.shape_8.setTransform(-39.3,6.8);
...
}).prototype = getMCSymbolPrototype(lib.head, new cjs.Rectangle(-226,-29.1,452.1,58.4), null);
...
(lib.notaPrawna = function(mode,startPosition,loop) {
	...
	this.sb.parent = this;
	this.sb.setTransform(736.9,9.9,1,1,0,0,0,0,-0.5);
	...
	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(255,255,255,0.949)").s().p("Eg6lAvqMAAAhfTMB1LAAAMAAABfTg");
	this.shape_1.setTransform(374,307.2);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.notaPrawna, new cjs.Rectangle(-1,-9.2,751.1,621.5), null);
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:1.02,scaleY:1.02},0).wait(1).to({scaleX:1.04,scaleY:1.04},0).wait(1).to({scaleX:1.07,scaleY:1.07},0).wait(1).to({scaleX:1.09,scaleY:1.09},0).wait(1).to({scaleX:1.11,scaleY:1.11},0).wait(1).to({scaleX:1.13,scaleY:1.13},0).wait(1).to({scaleX:1.15,scaleY:1.15},0).wait(1).to({scaleX:1.14,scaleY:1.14},0).wait(1).to({scaleX:1.14,scaleY:1.14},0).wait(1).to({scaleX:1.13,scaleY:1.13},0).wait(1).to({scaleX:1.12,scaleY:1.12},0).wait(1).to({scaleX:1.11,scaleY:1.11},0).wait(1).to({scaleX:1.1,scaleY:1.1},0).wait(1).to({scaleX:1.09,scaleY:1.09},0).wait(1).to({scaleX:1.08,scaleY:1.08},0).wait(1).to({scaleX:1.07,scaleY:1.07},0).wait(1).to({scaleX:1.06,scaleY:1.06},0).wait(1).to({scaleX:1.05,scaleY:1.05},0).wait(1).to({scaleX:1.04,scaleY:1.04},0).wait(1).to({scaleX:1.03,scaleY:1.03},0).wait(1).to({scaleX:1.02,scaleY:1.02},0).wait(1).to({scaleX:1.01,scaleY:1.01},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1));
...
// stage content:
(lib.bannertest = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.nota.setTransform(28,214.7,1,1,0,0,0,26.9,5.5);
	...
	this.shape_7.setTransform(687.2,52.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAbBIIgbgxIgbAxIgiAAIAthIIgqhHIAiAAIAZAxIAagxIAiAAIgsBHIAtBIg");
	this.shape_8.setTransform(708.8,36.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAkBIIgKgeIgzAAIgKAeIgfAAIA0iPIAeAAIAzCPgAgRATIAjAAIgSg3IAAAAg");
	this.shape_9.setTransform(696.5,36.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgNBIIAAh1IgmAAIAAgaIBnAAIAAAaIgmAAIAAB1g");
	this.shape_10.setTransform(686.2,36.7);

	this.instance_4 = new lib.ClipGroup_0();
	this.instance_4.parent = this;
	this.instance_4.setTransform(705.1,45.8,1,1,0,0,0,30,30);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#EDEDED","#FFFFFF"],[0,1],0,100,0,-100).s().p("Eg6lAPoIAA/PMB1LAAAIAAfPg");
	this.shape_11.setTransform(375,100);
...
p.nominalBounds = new cjs.Rectangle(375,100,751.1,821.5);
// library properties:
lib.properties = {
	width: 750,
	height: 200,
	...
	opacity: 1.00,
	manifest: [
		{src:"Image.png?1511560235891", id:"Image"}
	],
	preloads: []
};
